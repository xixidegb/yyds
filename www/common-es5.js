(function () {
  ...
  (self["webpackChunkYYDS"] = self["webpackChunkYYDS"] || []).push([["common"], {
    ...
    /***/
    51550: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    74081: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    43931: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "IonicAuthService": function IonicAuthService() {
          return (
            /* binding */
            _IonicAuthService
          );
      ...
      var _angular_fire_compat_auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! @angular/fire/compat/auth */
      83027);

      var _IonicAuthService = /*#__PURE__*/function () {
        function IonicAuthService(angularFireAuth) {
          _classCallCheck(this, IonicAuthService);

          this.angularFireAuth = angularFireAuth;
        }

        _createClass(IonicAuthService, [{
          key: "createUser",
          value: function createUser(value) {
            var _this = this;

            return new Promise(function (resolve, reject) {
              _this.angularFireAuth.createUserWithEmailAndPassword(value.email, value.password).then(function (res) {
                return resolve(res);
              }, function (err) {
                return reject(err);
              });
          ...
          key: "signinUser",
          value: function signinUser(value) {
            var _this2 = this;

            return new Promise(function (resolve, reject) {
              _this2.angularFireAuth.signInWithEmailAndPassword(value.email, value.password).then(function (res) {
                return resolve(res);
              }, function (err) {
                return reject(err);
              });
          ...
          value: function signoutUser() {
            ...
            return new Promise(function (resolve, reject) {
              if (_this3.angularFireAuth.currentUser) {
                _this3.angularFireAuth.signOut().then(function () {
        ...
        return IonicAuthService;
      }();

      _IonicAuthService.ctorParameters = function () {
        return [{
          type: _angular_fire_compat_auth__WEBPACK_IMPORTED_MODULE_0__.AngularFireAuth
        }];
      };

      _IonicAuthService = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.Injectable)({
        providedIn: 'root'
      })], _IonicAuthService);
      /***/
    },
    ...
    /***/
    43962: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
