(function () {
  ...
  (self["webpackChunkYYDS"] = self["webpackChunkYYDS"] || []).push([["src_app_login_login_module_ts"], {
    /***/
    90795: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _tabs_tabs_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ../tabs/tabs.page */
      43962);
      ...
      _LoginPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
    ...
    /***/
    77641: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _tabs_tabs_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../tabs/tabs.page */
      43962);
    ...
    /***/
    93721: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _LoginPage = /*#__PURE__*/function () {
        function LoginPage(router, ionicAuthService, fb, navCtrl) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function signIn(value) {
            ...
            this.ionicAuthService.signinUser(value).then(function (response) {
              console.log(response);
              _this.errorMsg = ""; //this.router.navigateByUrl('test');
              //this.router.navigate(['tabs']);

              _this.navCtrl.navigateForward(['tabs/tabs/tab1']);
            }, function (error) {
